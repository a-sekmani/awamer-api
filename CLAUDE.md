...
## Recent Changes
- 001-nestjs-project-setup: Added TypeScript 5.x (Node.js 20 LTS) + NestJS 10, Prisma 5, @nestjs/passport, passport-jwt,
- 001-nestjs-project-setup: Added [if applicable, e.g., PostgreSQL, CoreData, files or N/A]

## Active Technologies
- TypeScript 5.x (Node.js 20 LTS) + NestJS 10, Prisma 5, @nestjs/passport, passport-jwt, (001-nestjs-project-setup)
- PostgreSQL 15+ via Prisma ORM (001-nestjs-project-setup)
